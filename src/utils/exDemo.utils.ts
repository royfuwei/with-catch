import { getDemoValue } from './demo.utils';
/**
 * 使用 alias
 ...
 *   [plugin rpt2] ../../../ts-template/src/utils/exDemo.utils.ts:3:30 - error TS2307: Cannot find module '@/utils' or its corresponding type declarations.
 *
